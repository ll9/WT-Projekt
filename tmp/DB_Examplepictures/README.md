Here are some sample pictures of a SQLite Database which might be interesting for the project. The Databse (10.7GB) was created with IMDbPY and datasets from IMDB.
