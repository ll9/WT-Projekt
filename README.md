...
- [ ] Remove 'no more data' text, when endless scrolling is finished/ still loading (Wierer)
- [ ] Fix Endless Scrolling Bug (Scrolling Animation even though there is nothing more to scroll) (Wierer) !
